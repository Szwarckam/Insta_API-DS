...
import filtersController from "./04FILTERScontroller.js";
const filtersRouter = async (request, response) => {
  if (request.url.match(
    /\/api\/filters\/metadata\/([0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$)/) && request.method == "GET") {
